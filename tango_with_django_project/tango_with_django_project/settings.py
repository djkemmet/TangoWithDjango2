...
SECRET_KEY = '*fmo7_z)5q-m19^+vli8gp54labq1m92yvssg*(%@$@+$keyij'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth', # needed for Chapter 9
    'django.contrib.contenttypes', # needed for chapter 9
...
# Media Files (Profile Photos, Product Images, Uploads)
